...
api_vars=(
  ...
  REND_MEDIA_JOB_LEASE_SECS
  REND_MEDIA_JOB_HEARTBEAT_SECS
)
...
require_contains docs/templates/control-plane.Caddyfile "path /v1/* /v/* /embed-fast/* /readyz"
...
require_contains scripts/sync-control-plane-billing-env-over-ssh.sh "REND_PLAYBACK_BOOTSTRAP_PREFETCH_SEGMENTS"
require_contains .github/workflows/release-deploy.yml "REND_EDGE_CORS_ALLOWED_ORIGINS"
require_contains .github/workflows/release-deploy.yml "REND_PLAYBACK_BOOTSTRAP_PREFETCH_SEGMENTS"
