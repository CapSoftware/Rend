    ...
    <div className="overflow-x-clip">
      ...
      <main>
            ...
            <div className="max-w-[800px]">
              ...
              <div className="animate-rise animate-rise-2 mt-6 max-w-[660px] space-y-4 font-mono text-[14.5px] leading-[1.75] text-ink-soft sm:mt-7">
                <p>
                  ...
                  to upload, one playback URL that{" "}
                  <strong className="font-semibold text-ink">
                    starts fast
                  </strong>
                ...
                <p>
                  Rend serves generated HLS from{" "}
                  <Link
                    href="/performance"
                    className="text-ink underline decoration-accent/70 decoration-2 underline-offset-2 transition hover:decoration-accent"
                  >
                    Tigris-backed origin
                  </Link>{" "}
                  through Rend-controlled playback URLs today, so private
                  object-store links stay out of the browser. Rend is{" "}
                  <a
                    href={GITHUB_URL}
                    target="_blank"
        ...
        <Section id="performance" aria-label="Why Rend is fast">
          ...
          <SectionHeading
            title="Why it's fast"
            lede="When a video feels slow, it's rarely the server. It's the round trips before the first frame can show. Rend keeps those trips few and predictable with generated HLS served from Tigris-backed origin today."
          />
            ...
            {[
              {
                ...
                d: "Rend Cloud serves generated HLS directly from Tigris-backed origin today. The bare-metal edge path stays in the codebase for future reactivation when regional coverage makes it worthwhile.",
              },
              {
              ...
              },
              {
                ...
                d: "Rend builds playback artifacts during media processing so the player can start from real HLS media as soon as the asset reaches hls_ready.",
              },
            ].map((col) => (
        ...
        <Section id="open-source" tone="sunken" aria-label="Open source">
          ...
          <p className="mt-5 max-w-[620px] text-[17px] leading-[1.6] text-muted">
            It installs as one binary, with no database to set up and nothing
            phoning home. We don&apos;t charge for the software. We charge for
            the network that makes it fast.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-2.5">
            ...
            <Badge>
              Player &amp; SDKs <span className="text-faint">MIT</span>
            </Badge>
            <Badge>
              Self-host <span className="text-faint">Free forever</span>
            </Badge>
          </div>
        ...
        <Section id="pricing" tone="sunken" aria-label="Pricing">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="p-7">
              ...
              <p className="mt-2 text-[15px] text-muted">
                Included, every time. We transcode each upload into the
                renditions players need, and it never shows up on the bill.
              </p>
            </Card>
          </div>
        ...
        <Section aria-label="Built by the team behind Cap">
          <img
            src="/cap-logo.svg"
            alt="Cap"
            className="mb-6 h-8 w-auto sm:h-9"
          />
          <h2 className="text-[clamp(27px,5.6vw,44px)] leading-[1.12] sm:leading-[1.08]">
            Built by the team behind Cap
          </h2>
          <p className="mt-5 max-w-[640px] text-[17px] leading-[1.6] text-muted">
            We didn&apos;t set out to sell video infrastructure. We built Rend
            because Cap, our open source screen recorder, needed the fastest
            video infrastructure we could possibly build. Hundreds of thousands
            of people record with Cap, and every one of those videos has to be
            stored and served fast: petabytes of footage, played back the
            instant someone opens a share link.
          </p>
        ...
        <Section
          tone="ink"
          container={false}
          aria-label="Start in production"
          className="overflow-hidden"
        >
          <div
            aria-hidden="true"
            className="bg-line-grid pointer-events-none absolute inset-0 opacity-[0.06]"
          />
