...
export const features: Feature[] = [
  ...
  },
  {
    ...
    body:
      "Rend warms each video's opening bytes onto edge-local RAM and NVMe/SSD, close to your viewers, so playback starts while the rest streams in behind it.",
    detail: [
      "The opening seconds of every video are warmed onto edge-local memory and NVMe at upload time.",
      "The first request can return real frames instead of a round trip back to distant storage.",
      "Cold requests to a video nobody has watched yet still start fast.",
    ],
    icon: (
      <svg className="sketch block h-[78px] w-24 overflow-visible" viewBox="0 0 140 120" aria-hidden="true">
  ...
  },
  {
    ...
    body:
      "You pay for what's delivered and what's stored, priced by resolution. Encoding is included, with no per-minute fees and no surprise egress charges.",
    detail: [
