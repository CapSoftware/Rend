  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-[var(--sidebar-top,0px)] bottom-0 z-10 hidden h-[calc(100svh-var(--sidebar-top,0px))] w-[var(--sidebar-width)] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
