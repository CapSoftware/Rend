...
- Data dependencies: `DATABASE_URL`, `CLICKHOUSE_URL`,
...
- Control plane: `REND_CONTROL_PLANE_URL`, `REND_EDGE_BASE_URL`,
  `REND_EDGE_HEARTBEAT_INTERVAL_SECS`, optional `REND_EDGE_CACHE_MAX_BYTES`, and
  `REND_EDGE_VALIDATE_CACHE_ORIGIN=true`
